...
#
# Script generated by Vivado on Tue Jul 09 23:59:53 +0800 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/git-repository/Verilog_Project/ip_clk/prj/ip_clk_wiz/ip_clk_wiz.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
