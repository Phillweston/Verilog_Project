...
# UART port constraints
set_property -dict {PACKAGE_PIN T20 IOSTANDARD LVCMOS33} [get_ports uart_rxd]
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS33} [get_ports uart_txd]
...
connect_debug_port u_ila_0/probe2 [get_nets [list uart_rx_done]]
create_debug_port u_ila_0 probe
